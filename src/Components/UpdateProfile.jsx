...
const UpdateProfile = () => {
    ...
    return (
        <div className="mt-16 md:flex justify-center">
            <Helmet>
                <title>Home Seekers | User Profile</title>
            </Helmet>
            <div className="border md:flex flex-col items-center justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-100 dark:text-gray-800 ">
                ...
                <div className="space-y-4 text-center divide-y dark:divide-gray-300">
                    <div className="my-2 space-y-1">
                        ...
                        <p className="px-5 text-xl sm:text-base dark:text-gray-600"><span className="font-bold">Email:</span> {user.email}</p>
                        <p className="px-5 text-xl sm:text-base dark:text-gray-600"><span className="font-bold">Mobile:</span> {user.phoneNumber ? user.phoneNumber : "none"}</p>
                    </div>
            ...
            <div className="rounded-xl border border-violet-500 m-6">
                <section className="p-6 bg-white-100 text-gray-900">
                    <form onSubmit={handleFormSubmit} className="mt-12">
                        <input className="mb-4 w-full py-2 px-4 border-2 rounded-xl" type="text" name="username"
                            placeholder="Your Name" id="" required />
                        <br />
                        <input className="mb-4 w-full py-2 px-4 border-2 rounded-xl" type="text" name="photoURL"
                            placeholder="Photo URL" id="" required />
                        <br />
                        <input className="btn  bg-violet-500 text-white w-full py-2 px-4" type="submit" value="Update" />
                    </form>
                </section>
            </div>
