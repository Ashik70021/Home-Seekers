...
const About = () => {
    ...
    console.log(user)
    return (
        <div className="mx-auto mt-16 flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
            <Helmet>
            ...
            <div className="space-y-4 text-center divide-y dark:divide-gray-300">
                <div className="my-2 space-y-1">
                    ...
                    <p className="px-5 text-xl sm:text-base dark:text-gray-600">Email: {user.email}</p>
                    <p className="px-5 text-xl sm:text-base dark:text-gray-600">Mobile: {user.phoneNumber? user.phoneNumber: "none"}</p>
                </div>
